...
class TestPlants < GardenTest
  def test_plants_index
    Plant.create(variety_name: "Raf", crop_type: "tomato", garden_id: @garden.id)
    get "/plants"
  ...
  def test_plants_show
    plant = Plant.create(variety_name: "Raf", crop_type: "tomato", garden_id: @garden.id)
    get "/plants/#{plant.id}"
    assert_equal 200, last_response.status
    assert_includes last_response.body, "Raf"
  end
  ...
  def test_batch_advance
    p1 = Plant.create(variety_name: "Raf", crop_type: "tomato", lifecycle_stage: "germinating", garden_id: @garden.id)
    p2 = Plant.create(variety_name: "Roma", crop_type: "tomato", lifecycle_stage: "germinating", garden_id: @garden.id)
